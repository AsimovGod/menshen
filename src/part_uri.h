...
FvGtkUri(TgGtkLayout* UtGtkLayout, char* VcGtkUri)
{
    ...
    gtk_grid_set_column_homogeneous(GTK_GRID(UtGtkLayout->grid->uriBuild), TRUE);
    gtk_grid_set_column_homogeneous(GTK_GRID(UtGtkLayout->grid->uriParse), TRUE);
